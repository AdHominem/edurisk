...
```
cd existing_repo
git remote add origin https://gitlab.cs.fau.de/riscdev/fauriscproject.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.cs.fau.de/riscdev/fauriscproject/-/settings/integrations)
